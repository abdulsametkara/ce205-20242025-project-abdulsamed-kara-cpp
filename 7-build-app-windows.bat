...
call reportgenerator "-title:Task Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Task Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Task
call OpenCppCoverage.exe --export_type=binary:task_tests_unit_win.cov --sources src\task\src --sources src\task\header --sources src\tests\task -- build_win\build\Debug\task_tests.exe

echo Generate Test Coverage Data for Task App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=task_tests_unit_win.cov --export_type=cobertura:taskapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\task\src --sources src\task\header --sources src\taskapp\src --sources src\taskapp\header --sources src\tests\utility --sources src\tests\task -- build_win\build\Debug\taskapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Task Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/taskapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/task/src;src/task/header;src/taskapp/src;src/taskapp/header;src/tests/utility;src/tests/task" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/taskapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/task/src;src/task/header;src/taskapp/src;src/taskapp/header;src/tests/utility;src/tests/task" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\task\header "build_win\build\Release" /E
call robocopy src\taskapp\header "build_win\build\Release" /E
...
call robocopy src\task\header "build_win\build\Debug" /E
call robocopy src\taskapp\header "build_win\build\Debug" /E
